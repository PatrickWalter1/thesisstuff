...
#idexs = selector.get_support(indices=True)
#feat_df_sel= att_df[idexs]
#print(feat_df_sel.info())
...
plt.plot(lastyear[oneyear:],food17_pred_oneyear, color='blue', linewidth=1)

plt.scatter(lastyear[twoyear:oneyear],food17_test_twoyear_df,  color='black')
plt.plot(lastyear[twoyear:oneyear],food17_pred_twoyear, color='red', linewidth=1)

plt.scatter(lastyear[threeyear:twoyear],food17_test_threeyear_df,  color='black')
plt.plot(lastyear[threeyear:twoyear],food17_pred_threeyear, color='yellow', linewidth=1)

plt.scatter(lastyear[fouryear:threeyear],food17_test_fouryear_df,  color='black')
plt.plot(lastyear[fouryear:threeyear],food17_pred_fouryear, color='green', linewidth=1)

plt.plot(lastyear,food17_target_df[fiveyear:])

plt.scatter(lastyear[:fouryear],food17_test_fiveyear_df,  color='black')
plt.plot(lastyear[:fouryear],food17_pred_fiveyear, color='blue', linewidth=1)
...
plt.xlabel('Months')
#need to write script to compute dates from timestamps!
plt.title('2012-01-01 to 2016-12-01')
plt.show()


#plt.plot(,food17_pred_fouryear, color='blue', linewidth=3)
...
# Plot outputs
#plt.scatter(lastyear[oneyear:],food17_test_oneyear_df,  color='black')
plt.plot(lastyear[oneyear:],food17_pred_oneyear, color='blue', linewidth=1.5)

#plt.scatter(lastyear[twoyear:oneyear],food17_test_twoyear_df,  color='black')
plt.plot(lastyear[twoyear:oneyear],food17_pred_twoyear, color='red', linewidth=1.5)

#plt.scatter(lastyear[threeyear:twoyear],food17_test_threeyear_df,  color='black')
plt.plot(lastyear[threeyear:twoyear],food17_pred_threeyear, color='yellow', linewidth=1.5)

#plt.scatter(lastyear[fouryear:threeyear],food17_test_fouryear_df,  color='black')
plt.plot(lastyear[fouryear:threeyear],food17_pred_fouryear, color='green', linewidth=1.5)

plt.plot(lastyear,food17_target_df[fiveyear:])

#plt.scatter(lastyear[:fouryear],food17_test_fiveyear_df,  color='black')
plt.plot(lastyear[:fouryear],food17_pred_fiveyear, color='blue', linewidth=1.5)
...
print("fith year model tested on year one, two three four ")
# Make predictions using the testing set
food17_pred_oneyear = regr_fiveyear.predict(att_test_oneyear_df)
# The coefficients
print("2016")
print('Coefficients: \n', regr_oneyear.coef_)
# The mean absolute error
...
# Make predictions using the testing set
food17_pred_oneyear = regr_fiveyear.predict(att_test_twoyear_df)
# The coefficients
print("2015")
#print('Coefficients: \n', regr_oneyear.coef_)
# The mean absolute error
print("Mean absolute error: %.2f"
      % mean_absolute_error(food17_test_twoyear_df, food17_pred_oneyear))
# Explained variance score: 1 is perfect prediction
print('Variance score: %.2f' % r2_score(food17_test_twoyear_df, food17_pred_oneyear))
# Make predictions using the testing set

food17_pred_oneyear = regr_fiveyear.predict(att_test_threeyear_df)
# The coefficients
print("2014")
#print('Coefficients: \n', regr_oneyear.coef_)
# The mean absolute error
print("Mean absolute error: %.2f"
      % mean_absolute_error(food17_test_threeyear_df, food17_pred_oneyear))
# Explained variance score: 1 is perfect prediction
print('Variance score: %.2f' % r2_score(food17_test_threeyear_df, food17_pred_oneyear))

# Make predictions using the testing set
food17_pred_oneyear = regr_fiveyear.predict(att_test_fouryear_df)
# The coefficients
print("2013")
#print('Coefficients: \n', regr_oneyear.coef_)
# The mean absolute error
print("Mean absolute error: %.2f"
      % mean_absolute_error(food17_test_fouryear_df, food17_pred_oneyear))
# Explained variance score: 1 is perfect prediction
print('Variance score: %.2f' % r2_score(food17_test_fouryear_df, food17_pred_oneyear))
