...
attributes_df = attributes_df[170:-12]
...
if True:
    ...
    attributes_df = selector.fit_transform(attributes_df,food17_target_df[:-12])
    ...
    att_train_oneyear_df = attributes_df 
    #target groupings
...
if restaurants:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,restaurants_df[:-12])
...
if vegetables:
    ...
    attributes_df = selector.fit_transform(attributes_df,vegetables_df[:-12])
...
if other:
    ...
    attributes_df = selector.fit_transform(attributes_df,other_df[:-12])
...
if meat:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,meat_df[:-12])
...
if dairyandeggs:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,dairyandeggs_df[:-12])
...
if bakery:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,bakery_df[:-12])
...
if fruit:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,fruit_df[:-12])
...
if allitems:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,allitems_df[:-12])
...
if fromstores:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,fromstores_df[:-12])
...
if beef:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,beef_df[:-12])
...
if pork:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,pork_df[:-12])
...
if chicken:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,chicken_df[:-12])
    ...
    plt.ylabel('$')
    plt.xlabel('Months')
    plt.title('chicken 2017-01-01 to 2018-01-01')
    plt.show()
...
if dairy:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,dairy_df[:-12])
...
if eggs:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,eggs_df[:-12])
...
if coffee:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,coffee_df[:-12])
    ...
    plt.ylabel('$')
    plt.xlabel('Months')
    plt.title('coffee 2017-01-01 to 2018-01-01')
    plt.show()
...
if babyfood:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,babyfood_df[:-12])
...
if shelter:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,shelter18_df[:-12])
...
if transportation:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,transportation_df[:-12])
...
if gas:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,gas_df[:-12])
...
if energy:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,energy25_df[:-12])
...
if fishandseafood:
    attributes_df=att_df
    selector = SelectKBest(mutual_info_regression,k=9 )
    attributes_df = selector.fit_transform(attributes_df,fishandseafood_df[:-12])
